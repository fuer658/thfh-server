...
@Schema(description = "订单评价 - 用户对已购买商品的评价信息")
public class OrderComment {
    ...
    @Schema(description = "关联的订单", required = true)
    ...
    @Schema(description = "评价用户", required = true)
     ...
     */
    @Column(length = 1000)
    @Schema(description = "评价图片URL，多个图片用逗号分隔", example = "http://example.com/image1.jpg,http://example.com/image2.jpg")
